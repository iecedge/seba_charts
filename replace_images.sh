...
CONTAINER_REPLACEMENTS=(
  ...
  'docker.elastic.co/elasticsearch/elasticsearch-oss,akrainoenea/elasticsearch'
  'busybox,busybox'
  'gcr.io/google-containers/fluentd-elasticsearch,akrainoenea/fluentd-elasticsearch'
  'docker.elastic.co/kibana/kibana-oss,akrainoenea/kibana'
  'docker.elastic.co/logstash/logstash-oss,akrainoenea/logstash'
